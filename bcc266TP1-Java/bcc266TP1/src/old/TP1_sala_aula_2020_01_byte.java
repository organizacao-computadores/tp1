...
public class TP1_sala_aula_2020_01_byte {
	...
	// 1 byte = 2^8 = 256
	// (int) byte = 0 ... 255
	//[] byte => [] int => em cada posi��o vai variar de 0 a 255
	...
	TP1_sala_aula_2020_01_byte(){
		...
		// n�mero 39 em bin�rio
		//3 9 / 2 = 1 9  resta  1 
		//1 9 / 2 = 9  resta  1 
		//9 / 2 = 4  resta  1 
		//4 / 2 = 2  resta  0 
		//2 / 2 = 1  resta  0
		//1 / 2 = 0  resta 1 (crit�rio de parada)
		//3 9 = 1 0 0 1 1 1
		...
		System.out.println("Resultado multiplica��o: " + bytesToInt(RAM[1]));
		
		montarInstrucoesProgramaDivisao(30, 3);		
		System.out.println("Resultado divis�o: " + bytesToInt(RAM[3]));
