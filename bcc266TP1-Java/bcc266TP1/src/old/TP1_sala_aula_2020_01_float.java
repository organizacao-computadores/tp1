...
public class TP1_sala_aula_2020_01_float {
		...
		while(opcode!=-1){
			...
			switch (opcode){
				...
				case 0:{
					...
					// 0|33|12|-1 => o 33 eh o valor e n�o o endere�o apenas qdo o opcode � 0
	...
	public void montarInstrucoesProgramaMultiplicacao(int multiplicando, int multiplicador){
		...
		//para 35 x 18 tem q ter no m�nimo 18 instru��es do tipo SOMA
		//EXEMPLO DE INSTRU��O: -1 | -1 | -1 | -1 
		//outro exemplo de instru��o: 2 | 26 | 32 | 12
		...
		umaInstrucao[3] = -1; // o end que n�o serve para nada		
		memoriaInstrucoes[0] = umaInstrucao; // representa a 1a instru��o do programa
		
		
		umaInstrucao = new int[4];
		umaInstrucao[0] =0; // opcode igual a 0 => levar para RAM
		umaInstrucao[1] = 0; // valor a ser levado para RAM
		umaInstrucao[2] = 1; // posi��o da RAM onde vai ser armazenado o valor
		umaInstrucao[3] = -1; // end que nao serve para nada - LIXO		
		memoriaInstrucoes[1] = umaInstrucao; // representa 2a instru��o do programa
